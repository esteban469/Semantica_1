...
namespace Semantica_1
{
    public class Lexico : Token, IDisposable
    {
        ...
        public Lexico(string nombreArchivo = "prueba.cpp")
        {
            ...
            {
                throw new Error ("El archivo " + Path.GetExtension(nombreArchivo) + " no existe");    /* Defino una excepción que indica que existe un error con el archivo en caso de no ser encontrado */
